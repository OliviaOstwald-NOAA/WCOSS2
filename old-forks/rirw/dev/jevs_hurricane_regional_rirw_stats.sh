#PBS -S /bin/bash
#PBS -N jevs_hurricane_regional_rirw_stats
#PBS -j oe
#PBS -A ENSTRACK-DEV
#PBS -q dev
...
#export COMINbdeckNHC=/lfs/h2/emc/vpppg/noscrub/olivia.ostwald/MetTCData/bdeck/Year2022/Basin
export COMINbdeckNHC=/lfs/h2/emc/vpppg/noscrub/jiayi.peng/MetTCData/bdeck/Year2022
#export COMINbdeckJTWC=/lfs/h2/emc/vpppg/noscrub/olivia.ostwald/MetTCData/bdeck/Year2022/Basin
