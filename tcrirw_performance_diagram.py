# -*- coding: utf-8 -*-
"""tcrirw_performance_diagram

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eFvqcvEaZXx1P_Noyt4gW_lvez7uoM_r
"""
...
#  plt.clabel(ccsi,csilevs,inline=True,fmt='%.1f',fontsize=10,colors='black')
  ...
  # --- Reverting data points to original colors ---
  # The scatter plot and for loop below have been commented out.
  ...
  # --- Uncommented the original data plotting code ---
  ax.plot(SUR,POD,marker='o',markersize=10,c='#8400C8')
  ax.text(SUR,POD-0.03,'HFSA',fontsize=10,fontweight='bold',ha='center',va='bottom',color='#8400C8')

  ax.plot(SUR2,POD2,marker='o',markersize=10,c='#00DC00')
  ax.text(SUR2,POD2-0.03,'HFSB',fontsize=10,fontweight='bold',ha='center',va='bottom',color='#00DC00')

  ax.plot(SUR3,POD3,marker='o',markersize=10,c='#E63B7F')
  ax.text(SUR3,POD3-0.03,'HWRF',fontsize=10,fontweight='bold',ha='center',va='bottom',color='#E63B7F')

  ax.plot(SUR4,POD4,marker='o',markersize=10,c='#49D9DE')
  ax.text(SUR4,POD4-0.03,'HMON',fontsize=10,fontweight='bold',ha='center',va='bottom',color='#49D9DE')

  ax.plot(SUR5,POD5,marker='o',markersize=10,c='#000000')
  ax.text(SUR5,POD5-0.03,'GFS',fontsize=10,fontweight='bold',ha='center',va='bottom',color='#000000')

  ax.plot(SUR6,POD6,marker='o',markersize=10,c='#4287F5')
  ax.text(SUR6,POD6-0.03,'CTCX',fontsize=10,fontweight='bold',ha='center',va='bottom',color='#4287F5')
