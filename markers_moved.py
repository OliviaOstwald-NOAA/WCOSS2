...
Original file is located at
    https://colab.research.google.com/drive/14AFKyXhJXDcnjcuIyQyDR3pxZw3we5PT
"""
...
#  plt.clabel(ccsi,csilevs,inline=True,fmt='%.1f',fontsize=10,colors='black')
  ...
  # --- Updated plot title code ---
  # Build formal plot title
  rirw_thresh = os.environ['rirw_thresh']
  basin = os.environ['stormBasin']
  ...
  final_title = f'RI/RW Performance Diagram\n{formal_basin} Basin, {year}'
  plt.title(final_title, fontsize=12, fontweight="bold")
