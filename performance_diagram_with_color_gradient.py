...
Original file is located at
    https://colab.research.google.com/drive/1SzvRzaBPAc_8U2b0LTRpgWFUTR4qdf0N
"""
...
#  cbias =  ax.contour(x,y,bias,blevs,colors='black',linewidths=1,linestyles='--')
  ...
  # --- Code added to plot data points with a color gradient ---
  ...
  csi_values = np.array([csi_hfsa, csi_hfsb, csi_hwrf, csi_hmon, csi_gfs, csi_ctcx])
  model_names = ['HFSA', 'HFSB', 'HWRF', 'HMON', 'GFS', 'CTCX']

  # Choose a colormap and normalize the CSI data
  cmap = plt.get_cmap('viridis')
  norm = plt.Normalize(vmin=csi_values.min(), vmax=csi_values.max())

  # Create a single scatter plot with the color gradient
  sc = ax.scatter(
      sur_values,
      pod_values,
      c=csi_values,
  ...
  # Add a colorbar to the plot to show the CSI values
  ...
  # --- Existing plot code (commented out the old plot and legend calls) ---
